						...
						<div class="ff_center1">
							...
							<div class=biaodan>
								<form name=form1 action="LoginServlet?method=login" method=post >
									<ul>
									  <li>账&nbsp;&nbsp;&nbsp;号：<input name=email valid=required errmsg='账号不能为空' type="text"> <span id=errMsg_Name style=color:#FF0000></span></li>
									  <li>密&nbsp;&nbsp;&nbsp;码：<input name=password valid=required errmsg='密码不能为空' type="password"> <span id=errMsg_Name style=color:#FF0000></span></li>
									  <!-- <li>验证码：<input style='width:60px;' name=verifycode valid=required errmsg='验证码不能为空'> <img src="config/verifycode.php?temp=Math.random()" alt="验证码,看不清楚?请点击刷新验证码" style="vertical-align:bottom;cursor:pointer;" onClick="this.src='config/verifycode.php?temp='+Math.random()"> <span id=errMsg_verifycode style=color:#FF0000></span></li>
									  <li> -->
							...
							<div>
							     <p>如果你还没有账号，点击<a href="register.jsp" style="color:blue">这里</a>进行注册</p>
							</div>
