...
<body>
										...
										<c:forEach items="${magazineList}" var="magazine"
											...
											<tr>
												...
												<td><button class="btn btn-primary" data-toggle="modal"
														data-target="#myModal"
														onclick='getPeriodical(${magazine.id})'>分配期刊</button></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">选择期刊</h4>
				</div>
	...
	<script type="text/javascript">
        ...
        var mid;
        function getPeriodical(id) {
        	mid = id;
        	console.log("mid = " + mid);
            $.ajax({
                type : "post",
                url : "MajorEditorServlet",
                data : {"method":"getPeriodical"},
                dataType: 'json',
        ...
        function dispatch() {
            ...
            console.log("id = " +id );
                $.ajax({
                    type : "post",
                    url : "MajorEditorServlet",
                    data : {"method":"dispatchPeriodical","id":id,"mid":mid},
                    success : function(result) {
                        console.log(result);
        ...
        function addBody(result) {
            ...
            $.each(result,function(index, obj) {
               ...
               // parb.for="test"+obj.id;
                ...
                parb.innerHTML=obj.year+"年第"+obj.month+"期";
